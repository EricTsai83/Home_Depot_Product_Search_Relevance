...
class DataFrameParallelProcessor:
    ...
    """
    def __init__(self, processors, n_jobs=2): # my notebook only has 2 cpu
        self.processors = processors
        self.n_jobs = n_jobs
...
# 3rd solution in CrowdFlower
color_data = SourceFileLoader('COLOR_LIST', config.COLOR_DATA).load_module()
...
if __name__ == "__main__":
    ...
    a = DataFrameParallelProcessor(processors).process(df, columns = ['name', 'education'])
    print(a)